...
//        console  = new AmazonS3Client(credentials);
...
//         */
//        try {
//            List<Bucket> buckets = console.listBuckets();
//
//            long totalSize  = 0;
//            int  totalItems = 0;
...
//                 * method.
//                 */
//                ObjectListing objects = console.listObjects(bucket.getName());
//                do {
//                    for (S3ObjectSummary objectSummary : objects.getObjectSummaries()) {
//                        totalSize += objectSummary.getSize();
//                        totalItems++;
//                    }
//                    objects = console.listNextBatchOfObjects(objects);
